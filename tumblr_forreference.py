#
# NOT TO BE USED - FOR REFERENCE ONLY
#
...
from postertemp.encode import multipart_encode
from postertemp.streaminghttp import register_openers
...
class Api(object):
	def __init__(self, name, email=None, password=None, private=False, date=None, tags=None, format=None):
		self.name = name
